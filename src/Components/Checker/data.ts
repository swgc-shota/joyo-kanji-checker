export const checkerContent = `ここにテキストを入力すると、常用漢字は緑色、非常用漢字は赤色でハイライトされます。
また、「表記ゆれ」に追加された語は、波線付きの黄色でハイライトされます。
文脈によってOKになったりNGになったりする語の判別にお使いください。

以下サンプルです👇

私は、今宵、殺される。殺される為に走るのだ。身代りの友を救う為に走るのだ。王の奸佞邪智を打ち破る為に走るのだ。走らなければならぬ。そうして、私は殺される。若い時から名誉を守れ。さらば、ふるさと。若いメロスは、つらかった。幾度か、立ちどまりそうになった。えい、えいと大声挙げて自身を叱りながら走った。村を出て、野を横切り、森をくぐり抜け、隣村に着いた頃には、雨も止やみ、日は高く昇って、そろそろ暑くなって来た。メロスは額ひたいの汗をこぶしで払い、ここまで来れば大丈夫、もはや故郷への未練は無い。妹たちは、きっと佳い夫婦になるだろう。私には、いま、なんの気がかりも無い筈だ。まっすぐに王城に行き着けば、それでよいのだ。そんなに急ぐ必要も無い。ゆっくり歩こう、と持ちまえの呑気さを取り返し、好きな小歌をいい声で歌い出した。

走れメロス/太宰治（https://www.aozora.gr.jp/cards/000035/files/1567_14913.html）より抜粋`;

export const optionCotent = `# ア 次のような代名詞は，原則として，漢字で書く。
おれ
かれ
かのじょ
だれ
...
# ウ 次の接頭語は，その接頭語が付く語を漢字で書く場合は，原則として，
# 漢字で書き，その接頭語が付く語を仮名で書く場合は，原則として，仮名で書く。
# 御案内（御＋案内） 
ご案内
# 御挨拶（御＋挨拶）
ご挨拶
